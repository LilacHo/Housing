...
here::i_am("code/1_2_block_ndvi1.R")
...
# ============================================================
# TABLE 4: ΔGHI ~ Δlog(HU density) — does densification predict dimming?
# ============================================================
cat("\n================================================================\n")
cat("TABLE 4: ΔGHI ~ Δlog(HU density) regression by scenario\n")
cat("================================================================\n")
...
print(as.data.frame(densification_reg), digits = 6, row.names = FALSE)


# ============================================================
# TABLE 5: P(Bright → Dim) by densification quartile
# ============================================================
cat("\n================================================================\n")
cat("TABLE 5: P(Bright -> Dim) by densification quartile\n")
cat("  (among blocks that were Bright in 2010)\n")
cat("================================================================\n")
...
print(as.data.frame(transition_by_dens), digits = 3, row.names = FALSE)
